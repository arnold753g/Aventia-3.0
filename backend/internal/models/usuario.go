...
type Usuario struct {
	...
	EmailVerifyCodeHash     *string    `gorm:"type:text" json:"-"`
	EmailVerifyExpiresAt    *time.Time `json:"-"`
	EmailVerifyAttempts     int        `gorm:"default:0" json:"-"`
	EmailVerifyLastSentAt   *time.Time `json:"-"`
	EmailVerifySentCount    int        `gorm:"default:0" json:"-"`
	EmailVerificationToken  string     `gorm:"size:255" json:"-"`
	PasswordResetTokenHash  *string    `gorm:"type:text" json:"-"`
	PasswordResetExpiresAt  *time.Time `json:"-"`
	PasswordResetAttempts   int        `gorm:"default:0" json:"-"`
	PasswordResetLastSentAt *time.Time `json:"-"`
	PasswordResetSentCount  int        `gorm:"default:0" json:"-"`
