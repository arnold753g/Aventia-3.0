        ...
        <div>
          <span class="p-input-icon-left w-full">
            ...
            <InputText
              ...
              class="h-11 w-full rounded-full bg-white/10 border border-white/10 text-white placeholder-white/40 focus:border-white/30 focus:ring-2 focus:ring-white/20"
            />
          </span>
        </div>
