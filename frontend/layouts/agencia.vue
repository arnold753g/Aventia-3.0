<template>
  <div class="panel-shell panel-accent-green">
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center gap-8">
            <NuxtLink to="/agencia/dashboard" class="flex items-center gap-3">
              <div class="h-10 w-10 rounded-2xl border border-white/15 bg-white/10 flex items-center justify-center">
                <i class="pi pi-building text-lg text-white"></i>
              </div>
              <div class="leading-tight">
                <p class="text-sm uppercase tracking-[0.3em] text-white/50">Agencia</p>
