            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <InputMask v-model="form.telefono" mask="99999999" class="w-full" />
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <InputMask v-model="form.horario_apertura" mask="99:99" slotChar="HH:MM" class="w-full" />
                ...
                <div>
                  ...
                  <InputMask v-model="form.horario_cierre" mask="99:99" slotChar="HH:MM" class="w-full" />
